          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <div className="flex justify-center mb-6">
                <div className="inline-flex items-center rounded-full px-4 py-2 text-sm font-medium bg-blue-100 text-blue-600 dark:bg-blue-900/40 dark:text-blue-300">
                  <span className="flex h-2 w-2 rounded-full bg-blue-500 mr-2 animate-pulse"></span>
                  About Us
                </div>
              </div>
              <h1 className="text-5xl md:text-6xl font-display font-bold mb-8 text-blue-600 dark:text-blue-400">
                About Our Company
              </h1>

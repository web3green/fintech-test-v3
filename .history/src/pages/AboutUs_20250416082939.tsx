          ...
          <div className="container mx-auto px-6 md:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <div className="inline-flex items-center rounded-full px-3 py-1 text-sm font-medium bg-fintech-blue/10 text-fintech-blue dark:bg-fintech-blue/20 dark:text-fintech-blue-light mb-6">
              ...
              {/* First full-width text block */}
              <div className="mb-16">
                <div className="bg-blue-50/50 dark:bg-blue-900/10 rounded-2xl p-8 md:p-10 border border-blue-100/50 dark:border-blue-800/20 shadow-md">
                  <p className="text-xl md:text-2xl text-center text-muted-foreground font-medium leading-relaxed">
                    Founded in 2013, <span className="text-foreground dark:text-foreground">FinTechAssist</span> has grown from a small consultancy to a global leader in business registration and financial services. Our journey began with a simple mission: to make international business operations accessible to entrepreneurs worldwide.
                  </p>
                </div>
              </div>
            </div>
            ...
            {/* Second full-width text block */}
            <div className="max-w-6xl mx-auto mb-16">
              <div className="bg-fintech-orange/5 dark:bg-fintech-orange/10 rounded-2xl p-8 md:p-10 border border-fintech-orange/10 dark:border-fintech-orange/20 shadow-md">
                <p className="text-xl md:text-2xl text-center text-muted-foreground font-medium leading-relaxed">
            ...
            {/* Third full-width text block */}
            <div className="max-w-6xl mx-auto">
              <div className="bg-fintech-blue/5 dark:bg-fintech-blue/10 rounded-2xl p-8 md:p-10 border border-fintech-blue/10 dark:border-fintech-blue/20 shadow-lg">
          ...
          <div className="container mx-auto px-6 md:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-10 max-w-6xl mx-auto">
              {stats.map((stat, index) => (
                <div 
                  key={index} 
                  className="text-center p-8 bg-white dark:bg-gray-800 rounded-xl shadow-sm hover-scale"
                >
                  <div className="inline-flex items-center justify-center w-16 h-16 mb-6 bg-fintech-blue/10 dark:bg-fintech-blue/20 rounded-lg text-fintech-blue dark:text-fintech-blue-light">
                    <stat.icon className="h-8 w-8" />
                  </div>
                  <h3 className="text-4xl font-display font-bold text-fintech-blue dark:text-fintech-blue-light mb-3">{stat.value}</h3>
          ...
          <div className="container mx-auto px-6 md:px-8">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="prose prose-lg dark:prose-invert mx-auto">
                <p className="text-lg md:text-xl text-muted-foreground mb-10 leading-relaxed text-center max-w-4xl mx-auto">
                  {language === 'en' 
                    ? t('about.company.services')
                    : t('about.company.services')}
                </p>
                
                <p className="text-xl md:text-2xl font-medium text-center text-foreground">
                  {language === 'en' 
              ...
              {team.map((member, index) => (
                ...
                >
                  ...
                  <div className="p-8">
                    ...
                    <p className="text-lg text-fintech-blue dark:text-fintech-blue-light mb-4">{member.position}</p>

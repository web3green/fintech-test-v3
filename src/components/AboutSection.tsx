...
export function AboutSection() {
  ...
  return (
    <section id="about" className="section-padding py-16 md:py-24">
              ...
              <div className="aspect-[4/3] bg-gradient-to-br from-fintech-blue/80 to-fintech-blue-dark dark:from-fintech-blue/90 dark:to-fintech-blue-dark rounded-xl">
                <div className="absolute inset-0 flex items-center justify-center p-3 md:p-8">
                  <Card className="glass-card rounded-xl w-full mx-auto shadow-lg relative transition-all duration-300 hover:-translate-y-1">
                    ...
                    <CardContent className="p-4 md:p-6 space-y-3 md:space-y-5 relative z-10">
                      ...
                      <div className="space-y-2 md:space-y-3 bg-white/80 dark:bg-gray-900/30 p-3 rounded-lg backdrop-blur-sm border border-gray-200 dark:border-white/10 shadow-sm">

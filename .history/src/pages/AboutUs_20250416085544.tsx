  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        {/* Заголовок вверху по центру в отдельном блоке */}
        <section className="py-16 md:py-24 bg-gradient-to-b from-blue-50 to-white dark:from-blue-950/30 dark:to-gray-900">
        ...
        {/* Два блока с карточками - Блок 1: Карточка с информацией о компании */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8">
                <div className="text-center mb-6 lg:text-left">
                  <h2 className="text-2xl md:text-3xl font-display font-bold mb-4">Our Impact in Numbers</h2>
                  <p className="text-muted-foreground mb-4">See the results of our dedication to excellence and client satisfaction</p>
                </div>
                
                <div className="grid grid-cols-2 gap-4">
                  {stats.map((stat, index) => (
                    <div key={index} className="bg-white dark:bg-gray-800/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm">
        ...
        {/* Два блока с карточками - Блок 2: Команда */}
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-10">
                ...
                <div className="mt-8 bg-gradient-to-br from-blue-50/80 to-blue-100/50 dark:from-blue-900/20 dark:to-blue-800/10 p-5 rounded-lg border border-blue-100/70 dark:border-blue-700/30">

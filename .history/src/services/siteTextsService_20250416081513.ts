...
const initialTexts: TextBlock[] = [
  ...
  },
  {
    ...
    key: 'about.company.intro',
    section: 'About Us',
    content: {
      en: 'FintechAssist is a UK-based full-service consulting company. Our team has deep experience in banking, finance, law, and compliance.',
      ru: 'FintechAssist - Британская консалтингово-сервисная компания полного цикла. Мы - команда с большим опытом в банковской, финансовой, юридической сфере и комплаенса.'
    }
  },
  {
    id: 'about-company-approach',
    key: 'about.company.approach',
    section: 'About Us',
    content: {
      en: 'Whether you're a startup or a growing company, we attentively study your goals and demands, developing tailor-made solutions that perfectly align with your needs.',
      ru: 'Вы старт-ап или развивающаяся компания, мы внимательно выслушаем ваши пожелания и цели, подберем для вас оптимальное индивидуальное решение и реализуем в точности под ваши потребности.'
    }
  },
  {
    id: 'about-company-services',
    key: 'about.company.services',
    section: 'About Us',
    content: {
      en: 'We provide a comprehensive range of services, from company registration and account opening to financial licensing and accounting support. Our team will handle all the necessary documentation, including business plans, AML policies, and application forms, leveraging our years of expertise to ensure a smooth process.',
      ru: 'Мы предоставляем полный спектр услуг от регистраций компаний и открытия счетов, до получения финансовых лицензий и бухгалтерского обслуживания. Подготовим для вас весь необходимый пакет документов, включая бизнес план, AML политики, заполним документы на подачу, учитывая наш многолетний опыт.'
    }
  },
  {
    id: 'about-company-conclusion',
    key: 'about.company.conclusion',
    section: 'About Us',
    content: {
      en: 'Our services are designed to fully meet our clients' needs in the fintech and financial sectors.',
      ru: 'Все наши услуги полностью покрывают потребности клиентов в указанной сфере.'
    }
  }
];

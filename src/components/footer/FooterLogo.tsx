  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center">
        <svg width="32" height="32" viewBox="0 0 160 160" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-2">
          {/* Bottom blue element */}
          ...
          {/* Middle orange element (changed color to #F97316 while preserving shape) */}

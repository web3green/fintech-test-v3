...
import { Building, Landmark, Wallet, Gamepad, CreditCard, BarChart3, Briefcase, Shield, Globe, Scale, Banknote } from 'lucide-react';
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
      {services.map((service, index) => (
        <ServiceCard
          key={service.id}
          {...service}
          isOpen={openServices.includes(service.id)}

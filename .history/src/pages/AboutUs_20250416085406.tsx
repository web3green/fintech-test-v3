  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 md:py-24 bg-gray-50 dark:bg-gray-900">
          <div className="container mx-auto px-4">
            {/* Заголовок по центру отдельным блоком */}
            ...
            {/* Текстовый блок ниже заголовка */}
            <div className="max-w-3xl mx-auto text-center mb-16">
              <p className="text-lg text-muted-foreground">
                {language === 'en' 
                  ? 'We provide a wide range of financial and registration services to help your business succeed in the global market'
                  : 'Мы предоставляем широкий спектр финансовых и регистрационных услуг, чтобы помочь вашему бизнесу на международном рынке'}
              </p>
            </div>
            
            {/* Два блока с карточками */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="mb-4">
                  <div className="h-12 w-12 rounded-full bg-fintech-blue flex items-center justify-center shadow-md mb-4">
                    <Briefcase className="h-6 w-6 text-white" />
                  </div>
                  <h3 className="text-xl font-display font-bold mb-3">Business Registration</h3>
                </div>
                <ul className="space-y-2 text-muted-foreground mb-4">
                  <li className="flex items-start gap-2">
                    <span className="rounded-full h-5 w-5 bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center text-blue-600 dark:text-blue-400 text-xs mt-0.5">✓</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="rounded-full h-5 w-5 bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center text-blue-600 dark:text-blue-400 text-xs mt-0.5">✓</span>
                    <span>Corporate Banking Support</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="rounded-full h-5 w-5 bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center text-blue-600 dark:text-blue-400 text-xs mt-0.5">✓</span>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="mb-4">
                  <div className="h-12 w-12 rounded-full bg-fintech-orange flex items-center justify-center shadow-md mb-4">
                    <Globe className="h-6 w-6 text-white" />
                  </div>
                  <h3 className="text-xl font-display font-bold mb-3">Financial Services</h3>
                </div>
                <ul className="space-y-2 text-muted-foreground mb-4">
                  <li className="flex items-start gap-2">
                    <span className="rounded-full h-5 w-5 bg-orange-100 dark:bg-orange-900/30 flex items-center justify-center text-orange-600 dark:text-orange-400 text-xs mt-0.5">✓</span>
                    <span>Payment Processing Setup</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="rounded-full h-5 w-5 bg-orange-100 dark:bg-orange-900/30 flex items-center justify-center text-orange-600 dark:text-orange-400 text-xs mt-0.5">✓</span>
                    <span>Financial Licensing</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="rounded-full h-5 w-5 bg-orange-100 dark:bg-orange-900/30 flex items-center justify-center text-orange-600 dark:text-orange-400 text-xs mt-0.5">✓</span>
            ...
            <div className="max-w-3xl mx-auto text-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800/50 dark:to-gray-700/30 p-8 rounded-xl border border-gray-200 dark:border-gray-700">
              <p className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">
                {language === 'en' 
                  ? 'Ready to take your business global?'
                  : 'Готовы вывести свой бизнес на глобальный уровень?'}
              </p>
              <p className="text-muted-foreground mb-6">
                {language === 'en' 
              ...
              <a href="/services" className="inline-flex items-center justify-center rounded-md text-sm font-medium h-10 px-6 py-2 bg-fintech-blue text-white hover:bg-fintech-blue-dark transition-colors">
                {language === 'en' ? 'Explore All Services' : 'Изучить все услуги'}
              </a>
            </div>
          </div>
        </section>
